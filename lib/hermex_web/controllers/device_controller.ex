defmodule HermexWeb.DeviceController do
  use HermexWeb, :controller

  alias Hermex.Push.Device
  ...
  defp find_app(%{"app_id" => app_id}) do
    Repo.get!(Hermex.Push.App, app_id)
  end
  defp find_app(%{"app_name" => app_name, "platform" => platform}) do
    Repo.get_by!(Hermex.Push.App, name: app_name, platform: platform)
  end
  defp find_app(_), do: raise HermexWeb.BadRequestException, "need app_name and platform or app_id"
end
